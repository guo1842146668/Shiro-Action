...
public class CRC16 {
    ...
    public static String getCrc(String data) {
    	byte[] by = CRC16.toByteArray(data);//把收到的数据转成byte[]
        int calcCrc16 = CRC16.calcCrc16(by);//计算
        String crc16 = String.format("%04x", calcCrc16).toUpperCase();
        data += " " + crc16.substring(2, 4) + " " +crc16.substring(0, 2);
        return data.toUpperCase();
    }
    
//    // 测试
//    public static void main(String[] args) {
//    	System.out.println(getCrc("59 56 04 45 0A 13 46 61 24 3B 01 00 0b 37 00 01 01"));
//    }
